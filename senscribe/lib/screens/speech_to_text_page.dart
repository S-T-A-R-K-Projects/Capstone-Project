...
class _SpeechToTextPageState extends State<SpeechToTextPage> {
      ...
      if (status.isGranted) {
        _isAvailable = await _speech.initialize(
          onStatus: (status) {
            ...
            print('Has words: ${_currentWords.isNotEmpty}');
            ...
            if (status == 'done' || status == 'notListening') {
              ...
              if (mounted) {
                setState(() {
                  _isListening = false;
                  // Don't save here - let the final result callback handle it
                });
              }
            }
          },
  ...
  Future<void> _startListening() async {
    ...
    print('Available: $_isAvailable, Already listening: ${_speech.isListening}');
    ...
    try {
      ...
      await _speech.listen(
        onResult: (result) {
          print('Got result: ${result.recognizedWords}, final: ${result.finalResult}');
          if (mounted) {
                  ...
                  ? Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            _isListening ? 'Listening...' : 'No speech detected yet',
                            style: Theme.of(context)
                                .textTheme
                                .titleMedium
                                ?.copyWith(
